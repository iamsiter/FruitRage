...
public class calibrate {
	...
	public static void main(String[] args) {
		try {
            ...
            char[][] PLAY2 =new char[size][size];
            int val=0;
            for(int i=0;i<size;i++) {
            	for(int j=0;j<size;j++) {
            		PLAY[i][j]=(char)(val%10+'0');//worst case
            		val++;
            		PLAY2[i][j]='0';//best case
            	}
            }
			...
			minMaxValue = MaxValue(new State(PLAY2, 0, 0), Integer.MIN_VALUE, Integer.MAX_VALUE, 0);
